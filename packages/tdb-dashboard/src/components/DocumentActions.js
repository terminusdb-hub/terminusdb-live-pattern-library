...
export const getDocumentTools = () => {
    return <ButtonToolbar className="mb-3" aria-label="Toolbar with Button groups">
        ...
        <Button variant="secondary" title={"Update Document from a local json file"}><BiUpArrow/></Button>{' '}
        <Button variant="secondary" title={"Download Document"}><BiDownArrow/></Button>{' '}
