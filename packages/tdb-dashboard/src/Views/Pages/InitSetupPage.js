            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} lg={6} className="order-2 order-lg-1 text-lg-left">
                        {/*<h1 className=" text-info mt-5 d-flex text-center">
                            {WELCOME_MESSAGE} <span className="fw-bolder">{SERVICE_NAME}</span> 
                        </h1>
                        <p className="lead my-4 text-muted">{SERVICE_TITLE}</p>*/}
                        <h1 className=" text-info mt-5 d-flex-column ">
                            {WELCOME_MESSAGE} <strong >{SERVICE_NAME}</strong> 
                            <p className="lead my-4 text-muted">{SERVICE_TITLE}</p>
                        </h1>
                        <OrganizationForm/>
                    </Col>
