...
export const CANCEL_NEW_DATA_PRODUCT_BUTTON = {icon: "fas fa-times", variant:"outline-primary"}
//New Data product create button configurations
export const CREATE_NEW_DATA_PRODUCT_BUTTON = {label: "Create", title: "Create", icon: "fas fa-check", variant: "outline-primary"}
